                ...
                <form method="POST" action="{{route('loggedin')}}">
                    @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6 " type="password" name="password"  required>
                                    @error('password')
                            ...
                            @enderror
                            @if($errors->any())
                            <strong class="text-danger">Your Credentials are incorrect</strong>
                          @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('register')}}"><button class="btn btn--radius-2 btn--blue-2" type="button" style="background-color:green">Sign Up</button></a>
                        </div>
